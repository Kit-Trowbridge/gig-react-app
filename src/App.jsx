...
function App() {
  ...
  const favouritedGigs = gigs.filter((gig) => {return gig.favourited});

  return (
    <>
      {favouritedGigs.length > 0 && <h1>Favourites</h1>}
      <div className="favouritedGigs">
          <Gigs gigs={favouritedGigs}/>
      </div>
      

      <div className="unfavouritedGigs">
